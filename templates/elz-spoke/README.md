...
| Name | Type |
|------|------|
| [oci_core_drg_route_distribution_statement.hub_route_distribution_statement](https://registry.terraform.io/providers/oracle/oci/4.96.0/docs/resources/core_drg_route_distribution_statement) | resource |
...
| <a name="input_hub_drg_route_distribution"></a> [hub\_drg\_route\_distribution](#input\_hub\_drg\_route\_distribution) | OCID of route distribution list for hub. | `string` | `null` | no |
...
| <a name="input_spoke_drg_route_table_id"></a> [spoke\_drg\_route\_table\_id](#input\_spoke\_drg\_route\_table\_id) | OCID of DRG route table for Spoke | `string` | `null` | no |
