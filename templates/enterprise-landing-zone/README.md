...
| <a name="input_nonprod_enable_network_firewall"></a> [nonprod\_enable\_network\_firewall](#input\_nonprod\_enable\_network\_firewall) | Option to enable Network Firewall. | `bool` | `false` | no |
...
| <a name="input_prod_enable_network_firewall"></a> [prod\_enable\_network\_firewall](#input\_prod\_enable\_network\_firewall) | Option to enable Network Firewall. | `bool` | `false` | no |
