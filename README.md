...
at [templates/elz-workload](./Official_Documentation/OELZ_Workload_Deployment/elz-workload). Users can use the guides below to get started with Workload Expansion.
